...
\begin{document}
\input{title} \newpage
\input{kich_bur_task7} \newpage
\input{AfanasyevMM/task1} \newpage
\input{AfanasyevMM/task2} \newpage
\input{AfanasyevMM/task3} \newpage
\input{tyrlikova_Erlang_distribution} \newpage
\input{ust_awgn} \newpage
\input{mal_decibel} \newpage
\input{ust_signals} \newpage 
\input{kov_erlang} \newpage
\input{kov_frenc} \newpage
\input{ust_error} \newpage
\input{kich_bur_task1}\newpage
\input{vol_nmt} \newpage
\input{vol_dft} \newpage
\input{mal_noise} \newpage
\input{mal_con} \newpage
\input{mal_prog} \newpage
\input{AfanasyevMM/task4} \newpage
\input{kov_guard_interval} \newpage
\input{vol_guard_interval} \newpage
\input{Glebov} \newpage
